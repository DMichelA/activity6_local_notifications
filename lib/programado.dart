...
class programado extends StatefulWidget {
  @override
  _programado createState() => new _programado();
}

class _programado extends State<programado> {
...
//        context, new MaterialPageRoute(builder: (context) => new SecondPage(payload: payload )));
  ...
  Widget regreso() {
    Navigator.pop(
        context, MaterialPageRoute(builder: (context) => programado()));
  }
}
