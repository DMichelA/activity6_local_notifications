...
import 'actualizacionsemanal.dart';

class mostrarTarjetaSemanal extends StatefulWidget {
  @override
  _mostrarTarjetaSemanal createState() => new _mostrarTarjetaSemanal();
}

class _mostrarTarjetaSemanal extends State<mostrarTarjetaSemanal> {
  ...
  void refreshList() async {
    setState(() {
      recordatorios = dbHelper.getRecordatorios2();
    });
  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
      ...
      appBar: new AppBar(
        ...
        centerTitle: true,
        title: Text("Recordatorios Semanales",
            style: TextStyle(
                color: Colors.white,
                fontWeight: FontWeight.bold,
                fontSize: 20)),
                            ...
                            GestureDetector(
                              ...
                              onTap: () {
                                Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                        builder: (context) => actualizacionSemanal(snapshot.data[index].id)));
                              },
                            ),
                            Padding(
                            ...
                            Row(
                              children: <Widget>[
                                ...
                                FlatButton.icon(
                                  onPressed: () {
                                    cancelar(snapshot.data[index].id);
                                    dbHelper.delete2(snapshot.data[index].id);
                                    _showSnackbar(context,
