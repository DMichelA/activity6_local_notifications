...
import 'actualizaciondiario.dart';

class mostrarTarjetaDiario extends StatefulWidget {
  @override
  _mostrarTarjetaDiario createState() => new _mostrarTarjetaDiario();
}

class _mostrarTarjetaDiario extends State<mostrarTarjetaDiario> {
                            ...
                            GestureDetector(child:Text(
                              ...
                              style: TextStyle(
                                ...
                                Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                        builder: (context) => actualizacionDiario(snapshot.data[index].id)));
                            },),
