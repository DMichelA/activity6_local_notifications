...
class semanal extends StatefulWidget {
  @override
  _semanal createState() => new _semanal();
}

class _semanal extends State<semanal> {
  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
      ...
      appBar: new AppBar(
        ...
        centerTitle: true,
        title: Text("Create nuevo recordatorio semanal",
            style: TextStyle(
                color: Colors.white,
                fontWeight: FontWeight.bold,
                fontSize: 20)),
...
//    var reprogram = now.add(Duration(hours: 00, minutes: 00, seconds: 10));
  ...
  Widget regreso() {
    Navigator.pop(context, MaterialPageRoute(builder: (context) => semanal()));
  }
}
