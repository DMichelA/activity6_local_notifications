...
class actualizacionDiario extends StatefulWidget {
  int id;
  actualizacionDiario(this.id);

  @override
  _actualizacionDiarioState createState() => new _actualizacionDiarioState(this.id);
}

class _actualizacionDiarioState extends State<actualizacionDiario> {
  //VARIABLES REFERENTES AL MANEJO DE LA BD
  _actualizacionDiarioState(this.id);
  int id;
...
//  void refreshList() {
//    setState(() {
//      recordatorios = dbHelper.getRecordatorios();
//    });
//  }

  void enviaraclase() async {
    listarec = await dbHelper.decodificar();
    ...
    Navigator.push(
        ...
        MaterialPageRoute(
            builder: (context) =>
                mostrarNotificacion(id, nombren, fechan, horan)));
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  FlatButton.icon(
                      ...
                      label: Text(
                        'Selecciona hora del evento diariamente',
                        style: TextStyle(
                            color: Colors.lightBlue,
                            fontWeight: FontWeight.bold,
                            fontSize: 15),
...
//    var reprogram = now.add(Duration(hours: 00, minutes: 00, seconds: 10));
    ...
    await flutterLocalNotificationsPlugin.showDailyAtTime(
        id, nombre, hora, time, platformChannelSpecifics);
